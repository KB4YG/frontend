...
class BackendProvider {
  ...
  Future<http.Response> queryBackend(String path, Map<String, String>? parameters) async {
  ...
  Future<ParkingLot> getParkingLot(String parkingLotName) async {
    var response = await queryBackend('/location', {'parkingLotName': parkingLotName});
  ...
  Future<RecreationArea> getRecreationArea(String recreationAreaUrl) async {
    var response = await queryBackend('/location', {'ParkURL': recreationAreaUrl});
  ...
  Future<County> getCounty(String countyName) async {
    var response = await queryBackend('/location', {'county': countyName});
    var jsonObj = json.decode(response.body);
  ...
  Future<List<String>> getCountyList({String state = 'OR'}) async {
    var response = await queryBackend('/location', {'county': 'all'});
    var jsonObj = json.decode(response.body);
